void myplan(int plan) {
  ...
  if (plan == 3) {
    ...
    c(a++, 0, putih, 3,  8, 200,  120, 80, 0b11000000000011, atau, 0,  free,  100,  100,  100, putih, 0b01100000000000, atau); //15
    ...
    c(a++, 0, putih, 3,  8, 0,  0, 0, TM         , atau, 0,  free,  -120,  120,  350, putih, 0b11000000000000, atau); //18
